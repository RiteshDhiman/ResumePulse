...
function CheckScore() {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen flex flex-col items-center">
      <h1 className="w-[35.3125rem] text-white text-center mt-14 font-bold mt-6 text-3xl mx-auto font-krona break-words mt-20">
        Check Resume
      </h1>
     <div className='left-8 absolute mt-14'>
      <div className="bg-gray-900 rounded-lg p-6 shadow-md w-104 mt-8">
        <div className="flex items-center mb-4">
          <img src="/images/uploadResume.png" alt="Upload Icon" className="h-14 w-14 text-green-500 mr-2" />
        ...
        <div className="flex justify-between mt-6">
          ...
          <p className="text-gray-400 mt-4 text-[1.784rem] mr-3 font-medium font-Inter">Don't have a resume?</p>
      ...
      <div className=' relative   mt-96 p-4 ml-80 '>

      <div className="flex items-center mt-80 ml-96 ">
      
      <h2 className="text-lime-600 text-[2.09125rem] font-medium font-Inter mb-4 ml-32 text-center">Enter Job Description</h2>
     
      </div>
      
     
      <div className="bg-gray-900 rounded-lg p-4 border-dashed border-2 border-gray-500  ml-96 ">
        <div className="w-[33.75rem] h-80 relative">
          
          <div className="flex flex-col items-center justify-center h-full">
        
            <textarea
              className="w-full h-full p-0 bg-gray-900 text-center text-white resize-none outline-none"
      ...
      <button
        className="relative w-[26.686875rem] h-[4rem] mt-20 mb-8 bg-lime-600 rounded-[1.86625rem] border border-black text-white text-[2.409375rem] font-normal font-Poppins flex items-center justify-center"
