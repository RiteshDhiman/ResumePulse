  ...
  return (
    (<div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="flex items-center justify-center group/file rounded-lg cursor-pointer w-full relative overflow-hidden">
        <input
          ref={fileInputRef}
        ...
        <div className="flex flex-col items-center justify-center">
          <p
            className="relative  font-sans font-bold text-neutral-700 dark:text-neutral-300 text-base">
            Upload file
          </p>
          <p
            className="relative  font-sans font-normal text-neutral-400 dark:text-neutral-400 text-base mt-2">
          ...
          <div className="relative w-full max-w-xl mx-auto">
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-10 bg-white dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
